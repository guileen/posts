...
__jade.unshift({ lineno: 13, filename: __jade[0].filename });
buf.push('<a');
buf.push(attrs({ 'href':("#"), 'style':("background-image:url('" + ( avatar(user, 64) ) + "')"), 'title':("Jason's blog"), "class": ('avatar') }));
buf.push('>');
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.shift();
buf.push('</a>');
...
buf.push('>smartDate(new Date(post.createTime))');
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.shift();
buf.push('</span>');
__jade.shift();
...
buf.push('</div>');
__jade.shift();
__jade.unshift({ lineno: 98, filename: __jade[0].filename });
buf.push('<div');

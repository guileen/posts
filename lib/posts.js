...
exports.route = function(app) {
  ...
  app.get('/api/post/timeline/:start', function(req, res, next) {
      var len = 10;
  ...
  app.post('/api/post/:id/like/:value', function(req, res, next) {
      var method;
      ...
      community[method](req.session.userkey, 'post:' + req.params.id, function(err, data) {
          if(err) {return next(err);}
          res.json(data);
      })
  })
